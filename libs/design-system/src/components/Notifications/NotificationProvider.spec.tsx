...
const TestConsumer: React.FC = () => {
  const { notifications, success, error, warning, info, dismiss, clearAll, markAsRead, unreadCount } = useNotifications();
  
  return (
    <div>
      <button onClick={() => success('Success Title', 'Test message')}>
        Add Success
      </button>
