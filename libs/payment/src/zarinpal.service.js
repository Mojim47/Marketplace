    ...
    async requestPayment(request) {
        try {
            ...
            if (!request.description || request.description.length < 3) {
                throw new common_1.BadRequestException('Description is required and must be at least 3 characters');
            }
...
exports.ZarinpalService = ZarinpalService = ZarinpalService_1 = __decorate([
