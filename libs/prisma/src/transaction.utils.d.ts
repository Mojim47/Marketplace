...
export interface PrismaClientLike {
    $transaction<T>(fn: (tx: TransactionClient) => Promise<T>, options?: {
 ...
 * ```
 */
export declare function executeTransaction<T>(prisma: PrismaClientLike, operation: (tx: TransactionClient) => Promise<T>, options?: TransactionOptions): Promise<TransactionResult<T>>;
/**
 ...
 * ```
 */
export declare function withOptimisticLock<T extends {
    version: number;
}>(prisma: PrismaClientLike, modelName: string, id: string, expectedVersion: number, operation: (tx: TransactionClient, entity: T) => Promise<T>, options?: TransactionOptions): Promise<TransactionResult<T>>;
/**
 ...
 * ```
 */
export declare function executeBatchTransaction<T>(prisma: PrismaClientLike, operations: Array<(tx: TransactionClient) => Promise<T>>, options?: TransactionOptions): Promise<TransactionResult<T[]>>;
/**
 * Execute a read-only transaction with REPEATABLE_READ isolation
 *
 * Ensures consistent reads across multiple queries
 */
export declare function executeReadOnlyTransaction<T>(prisma: PrismaClientLike, operation: (tx: TransactionClient) => Promise<T>, options?: Omit<TransactionOptions, 'isolationLevel'>): Promise<TransactionResult<T>>;
/**
 ...
 */
export declare function executeFinancialTransaction<T>(prisma: PrismaClientLike, operation: (tx: TransactionClient) => Promise<T>, options?: Omit<TransactionOptions, 'isolationLevel'>): Promise<TransactionResult<T>>;
