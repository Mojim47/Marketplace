...
export class LogSanitizer {
    ...
    patterns;
    config;
    logger = new Logger(LogSanitizer.name);
    constructor(config = {}) {
    ...
    isSensitiveField(fieldName) {
        ...
        return (this.sensitiveFields.has(normalized) || this.sensitiveFields.has(fieldName.toLowerCase()));
    }
    /**
 ...
 */
export function getLogSanitizer(config) {
