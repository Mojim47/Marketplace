...
exports.SYSTEM_SAFETY_STATUS = exports.DETECTION_POINTS = exports.KILL_SWITCH_CONDITIONS = exports.ERROR_INVARIANTS = exports.ERROR_CODE_STATUS_MAP = exports.PAYMENT_INVARIANTS = exports.AUTH_INVARIANTS = void 0;
...
exports.PAYMENT_INVARIANTS = {
    ...
    IDEMPOTENCY_KEY_BINDING: {
        ...
        signal: (stored, incoming) => stored.key === incoming.key && stored.authority !== incoming.authority,
...
exports.ERROR_INVARIANTS = {
    ...
    NOT_FOUND_IS_404: {
        ...
        signal: () => exports.ERROR_CODE_STATUS_MAP[app_error_1.ErrorCode.RESOURCE_NOT_FOUND] !== common_1.HttpStatus.NOT_FOUND,
        consequence: 'BUILD_FAILURE',
        enforceable: true,
    },
    /**
