...
export class JWTAuthGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!token) {
      ...
      throw new UnauthorizedException(' Êò‰ «Õ—«“ ÂÊÌ  Ì«›  ‰‘œ');
    }
    ...
    if (result.payload.scope === 'refresh') {
      ...
      throw new UnauthorizedException(' Êò‰ ‰«„⁄ »— «” ');
    }
  ...
  private getErrorMessage(error?: string): string {
    const messages: Record<string, string> = {
      'Invalid token format': '›—„   Êò‰ ‰«„⁄ »— «” ',
      'Invalid header encoding': ' Êò‰ ‰«„⁄ »— «” ',
      'Invalid algorithm': ' Êò‰ ‰«„⁄ »— «” ',
      'Unknown key ID': ' Êò‰ „‰ﬁ÷Ì ‘œÂ «” . ·ÿ›« œÊ»«—Â Ê«—œ ‘ÊÌœ',
      'Invalid signature': ' Êò‰ ‰«„⁄ »— «” ',
      'Invalid payload encoding': ' Êò‰ ‰«„⁄ »— «” ',
      'Token expired': ' Êò‰ „‰ﬁ÷Ì ‘œÂ «” . ·ÿ›« œÊ»«—Â Ê«—œ ‘ÊÌœ',
      'Invalid issuer': ' Êò‰ ‰«„⁄ »— «” ',
    };

    return messages[error || ''] || ' Êò‰ ‰«„⁄ »— «” ';
  }
}
