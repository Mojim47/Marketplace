...
export const PERSIAN_ERROR_MESSAGES: Record<number, string> = {
  ...
  [HttpStatus.PRECONDITION_FAILED]: '��ԝ��؝�� ������� ���� ���',
  ...
  [HttpStatus.FAILED_DEPENDENCY]: '����ʐ� ������',
  [HttpStatus.PRECONDITION_REQUIRED]: '��ԝ��� ���� ���� ���',
  [HttpStatus.TOO_MANY_REQUESTS]: '����� ������ʝ�� ��� �� �� ���� ���',
  ...
  [HttpStatus.GATEWAY_TIMEOUT]: '���� ���Ν��� ����� �� ����� ����',
  [HttpStatus.HTTP_VERSION_NOT_SUPPORTED]: '���� HTTP �������� ������',
};
...
function getPersianMessage(status: number, originalMessage: string, errorCode?: string): string {
  ...
  if (AUTH_STATUS_CODES.includes(status)) {
    return PERSIAN_ERROR_MESSAGES[status] || '����� ���� ������ ���';
  }
